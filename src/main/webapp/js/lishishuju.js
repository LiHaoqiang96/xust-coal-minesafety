...
var chart8
initHistoryChart = () => {
	chart5 = echarts.init(document.getElementById("fenxi1"),'dark');
	chart6 = echarts.init(document.getElementById("fenxi2"),'dark');
	chart8 = echarts.init(document.getElementById("fenxi4"),'dark');
	chart7 = echarts.init(document.getElementById("fenxi3"),'dark');
	var option5 = {
		//设置全局背景色
